...
export default function Jaipur() {
  return (
    <section>
      <div>
        <img src="https://i0.wp.com/lighttravelaction.com/wp-content/uploads/2020/07/lighttravelaction-hawa-mahal-jaipur-guide-1.jpg?resize=825%2C550&ssl=1" alt="The Taj" className='relative w-full h-2/3' />
        <div className='absolute top-96 text-center mx-96 px-44  '>
          <h2 className='text-7xl text-white font-thin'>Rent</h2>
          <h2 className='text-7xl text-white font-thin'><span className='font-semibold'>Luxury Cars</span> for <span className='font-semibold'>Jaipur</span></h2>
        </div>
          ...
          <div>
                  ...
                  <p className='text-center text-7xl mt-3 font-light'>
                    a Luxury Car for <span className='font-medium'>Jaipur?</span>
                  </p>
                  <div>
          ...
          <div className='mt-60' >
            <p className='text-center text-5xl font-light'>
              Renting a luxury car in <span className='font-medium'>Jaipur</span>
            </p>
