...
export default function Signup() {
  return (
    <section>
        <div>
            <img src="Sign2.jpg" alt="signup pic" className='relative'/>
            <div className='absolute w-[35%] top-[25%]  right-[3%] shadow-2xl bg-transparent '>
                <h1 className='text-center text-white font-semibold text-5xl my-4'>Sign Up</h1>
                ...
                <form>
                    ...
                    />
                    <div className='flex justify-between mx-14 my-2'>
