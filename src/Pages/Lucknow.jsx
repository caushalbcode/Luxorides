...
export default function Lucknow() {
  return (
    <section>
      <div>
        <img src="https://c0.wallpaperflare.com/preview/328/50/367/india-city-of-navabs-uttar-pradesh-kudia-ghat.jpg" alt="The Taj" className='relative w-full h-2/3' />
        <div className='absolute top-96 text-center px-44  '>
          <h2 className='text-7xl text-white font-thin mx-72'>Rent</h2>
          <h2 className='text-7xl text-white font-thin mx-72'><span className='font-semibold'>Luxury Cars</span> for <span className='font-semibold'>Lucknow</span></h2>
        </div>
          ...
          <div>
                  ...
                  <p className='text-center text-7xl mt-3 font-light'>
                    a Luxury Car for <span className='font-medium'>Lucknow?</span>
                  </p>
                  <div>
          ...
          <div className='mt-60' >
            <p className='text-center text-5xl font-light'>
              Renting a luxury car in <span className='font-medium'>Lucknow</span>
            </p>
