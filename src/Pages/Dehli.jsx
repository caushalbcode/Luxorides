...
export default function Dehli() {
  return (
    <section>
      <div>
        <img src="https://img.theculturetrip.com/wp-content/uploads/2015/12/India_Gate_at_Night-e1450397705487.jpg" alt="The Taj" className='relative w-full' />
        <div className='absolute top-52 right-44 text-right animate-bounce'>
          ...
          <h2 className='text-7xl text-[#c1c1c1] font-thin'>for <span className='font-semibold'>Dehli</span></h2>
        </div>
          ...
          <div>
                  ...
                  <p className='text-center text-7xl mt-3 font-light'>
                    a Luxury Car for <span className='font-medium'>Dehli?</span>
                  </p>
                  <div>
          ...
          <div className='mt-60' >
            <p className='text-center text-5xl font-light'>
              Renting a luxury car in <span className='font-medium'>Dehli</span>
            </p>
