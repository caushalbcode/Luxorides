  ...
  return (
    <div className=''>
        <footer className=''>
            ...
            <div className='bg-black h-auto sm:items-center '>
                <div className='bg-black h-auto flex flex-wrap text-center'>
                    <div className='flex flex-wrap justify-center sm:space-x-4 md:space-x-20 lg:space-x-48 xl:space-x-48 sm:space-x-5 py-14 lg:mx-28'>
                        <div>
                            <img src="https://luxorides.com/assets/images/luxorides-square-logo-only-solid-whitepng-400ppi-9-500x500.webp" 
                                alt="luxorides logo"
                                className='h-28 sm:justify-items-center'
                            />
                        </div>
                        <div>
